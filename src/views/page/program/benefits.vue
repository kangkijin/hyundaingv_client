      ...
      <div class="w-[1320px] mx-auto">
        ...
        <div class="images flex flex-row w-full justify-between flex-wrap gap-y-8 mt-8">
          <m-image-card
            ...
            :key="key"
            :url="'/src/assets/images/image_benefits.png'"
            width="410px"
            height="260px"
          ...
          >
            <template v-slot:content>
              <p
                class="text-black font-medium font-Notokr text-2xl mt-[40px]"
                @click="openDialog(item)"
              >
                {{ item.title }}
              </p>
              <p class="text-[#585D72] font-normal font-Notokr text-lg mt-[20px]">
                {{ item.content }}
              </p>
            </template>
          </m-image-card>
        ...
        <div
          v-if="paginatedMarketingList.length > 8"
          class="flex justify-center gap-4 paging mt-14"
        >
